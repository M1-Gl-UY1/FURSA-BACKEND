...
public class ProprieteService {
    ...
    // V2 I (06/06/2026) : phase Certification supprimee. Toutes les methodes
    // (uploadDocumentCertification, soumettreCertification, approuverCertification,
    // refuserCertification, listerEnAttenteCertification) ont ete retirees car
    // redondantes avec la validation du wizard (EN_REVIEW -> ACCEPTEE).
    // Les colonnes statutCertif, certifie, certifieLe, certifSoumiseLe,
    // certifMotifRefus sont conservees en base pour eviter toute migration
    // destructive (les biens existants gardent leur etat historique).
